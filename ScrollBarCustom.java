...
public class ScrollBarCustom extends JScrollPane {
    ...
    public ScrollBarCustom(Component view) {
        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }

    public ScrollBarCustom(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public ScrollBarCustom(Component view, int vsbPolicy, int hsbPolicy) {
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(ScrollBarCustom sp) {
            this.sp = sp;
        }
